...
test.describe("Strategy Pattern - Price Calculator Strategies", () => {
  test.beforeEach(
    async ({
      ...
      // Przejdź do strony
      await page.goto(
        "/patterns/behavioral/strategy-price-calculator/index.html",
      );
    },
  );

  test("Should initialize with Regular strategy and default price", async ({
    page,
  }) => {
  ...
  test("Should calculate Regular price (no change)", async ({
    page,
  }) => {
    const input =
      page.locator(
  ...
  test("Should apply Discount strategy (20% off)", async ({
    page,
  }) => {
    const input =
      page.locator(
  ...
  test("Should apply Tax strategy (23% VAT)", async ({
    page,
  }) => {
    const input =
      page.locator(
  ...
  test("Should apply Premium strategy (+50%)", async ({
    page,
  }) => {
    const input =
      page.locator(
  ...
  test("Should switch between strategies dynamically", async ({
    page,
  }) => {
    const result =
      page.locator(
  ...
  test("Should update price when input changes with active strategy", async ({
    page,
  }) => {
    const input =
      page.locator(
  ...
  test("Should highlight active strategy card", async ({
    page,
  }) => {
    const discountCard =
      page.locator(
    ...
    await discountCard.click();
    let classAttr =
      await discountCard.getAttribute(
        "class",
      );
    expect(
      classAttr,
  ...
  test("Should work with zero and negative prices", async ({
    page,
  }) => {
    const input =
      page.locator(
  ...
  test("Should format numbers with comma as decimal separator", async ({
    page,
  }) => {
    const input =
      page.locator(
